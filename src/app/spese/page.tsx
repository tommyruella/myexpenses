...
export default function SpesePage() {
  ...
  return (
    <>
      <Navbar />
      <div className="spese-page-root" style={{ maxWidth: 900, margin: '0 auto', padding: '32px 0 0 0', minHeight: '80vh' }}>
        <h1 className="section-title all-expenses-mobile-margin" style={{ fontSize: 38, marginBottom: 32, textAlign: 'left' }}>All Expenses</h1>
        <div className="filters-row filters-mobile-margin" style={{ display: 'flex', flexWrap: 'wrap', gap: 12, marginBottom: 24, marginRight: 20}}>
          <input
            type="text"
