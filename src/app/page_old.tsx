...
import { PieChart, Pie, Cell, LineChart, Line, ResponsiveContainer, AreaChart, Area } from 'recharts';
import { Plus, Trash2, TrendingUp, TrendingDown, Wallet, Eye, EyeOff, Grid3X3, BarChart3, Zap } from 'lucide-react';

const CATEGORIE = ["FOOD", "TRANSPORT", "FITNESS", "MISC"];
...
const THEME = {
  ...
  categories: {
    FOOD: { primary: '#f97316', gradient: 'from-orange-500 to-red-500' },
    TRANSPORT: { primary: '#06b6d4', gradient: 'from-cyan-500 to-blue-500' },
    FITNESS: { primary: '#10b981', gradient: 'from-emerald-500 to-teal-500' },
    MISC: { primary: '#8b5cf6', gradient: 'from-violet-500 to-purple-500' }
  }
} as const;
